...
class AdSize {
  ...
  static Future<AnchoredAdaptiveBannerAdSize?> getCurrentOrientationAnchoredAdaptiveBannerAdSize(
      int width) async {
    final num? height = await instanceManager.channel.invokeMethod<num?>(
      'AdSize#getAnchoredAdaptiveBannerAdSize',
      <String, Object?>{
...
/// Preload Native is a native ad, but can set factory id after
class PreloadNativeAd extends AdWithView {
  /// Creates a [PreloadNativeAd].
  ///
  /// A valid [adUnitId], nonnull [listener], nonnull [request]
  /// Use [nativeAdOptions] to customize the native ad request.
  /// Use [customOptions] to pass data to your native ad factory.
  PreloadNativeAd({
    required String adUnitId,
  ...
  /// Creates a [PreloadNativeAd] with Ad Manager.
  ///
  /// A valid [adUnitId], nonnull [listener], nonnull [adManagerRequest]
  /// Use [nativeAdOptions] to customize the native ad request.
  /// Use [customOptions] to pass data to your native ad factory.
  PreloadNativeAd.fromAdManagerRequest({
    required String adUnitId,
    required this.listener,
    required this.adManagerRequest,
    this.nativeAdOptions,
  ...
  @override
  Future<void> load() async {
    await instanceManager.loadPreloadNativeAd(this);
  }
  ...
  Future<void> setPlatformView(
    ...
    await instanceManager.setPlatformView(
      this,
      factoryId,
      nativeTemplateStyle,
    );
...
class InterstitialAd extends AdWithoutView {
  ...
  static Future<void> load({
    ...
    InterstitialAd ad =
        InterstitialAd._(adUnitId: adUnitId, adLoadCallback: adLoadCallback, request: request);
...
class RewardedAd extends AdWithoutView {
  ...
  static Future<void> load({
    ...
    RewardedAd rewardedAd = RewardedAd._(
        adUnitId: adUnitId, request: request, rewardedAdLoadCallback: rewardedAdLoadCallback);
...
class NativeAdOptions {
  ...
  @override
  int get hashCode => Object.hash(adChoicesPlacement, mediaAspectRatio, videoOptions,
      requestCustomMuteThisAd, shouldRequestMultipleImages, shouldReturnUrlsForImageAssets);
}
