...
public class GoogleMobileAdsPlugin
  ...
  public static boolean registerNativeAdFactory(
    ...
    final GoogleMobileAdsPlugin gmaPlugin = (GoogleMobileAdsPlugin) engine
      .getPlugins()
      .get(GoogleMobileAdsPlugin.class);
  ...
  public static boolean registerMediationNetworkExtrasProvider(
    ...
    if (gmaPlugin.adMessageCodec != null) {
      gmaPlugin.adMessageCodec.setMediationNetworkExtrasProvider(
   ...
   */
  @Deprecated
  public static void unregisterMediationNetworkExtrasProvider(
    FlutterEngine engine
  ) {
    final GoogleMobileAdsPlugin gmaPlugin = (GoogleMobileAdsPlugin) engine
      .getPlugins()
  ...
  public static NativeAdFactory unregisterNativeAdFactory(
    ...
    final FlutterPlugin gmaPlugin = engine
      .getPlugins()
      .get(GoogleMobileAdsPlugin.class);
    if (gmaPlugin != null) {
      return ((GoogleMobileAdsPlugin) gmaPlugin).removeNativeAdFactory(
          factoryId
        );
    }
  ...
  private boolean addNativeAdFactory(
    String factoryId,
    NativeAdFactory nativeAdFactory
  ) {
    if (nativeAdFactories.containsKey(factoryId)) {
      final String errorMessage = String.format(
        "A NativeAdFactory with the following factoryId already exists: %s",
        factoryId
      );
  ...
  public void onAttachedToEngine(FlutterPluginBinding binding) {
    ...
    if (mediationNetworkExtrasProvider != null) {
      adMessageCodec.setMediationNetworkExtrasProvider(
        mediationNetworkExtrasProvider
      );
    }
  ...
  public void onMethodCall(
    ...
    if (instanceManager == null || pluginBinding == null) {
      Log.e(
        TAG,
        "method call received before instanceManager initialized: " +
        call.method
      );
      return;
    }
    ...
    switch (call.method) {
      ...
      case "MobileAds#initialize":
        flutterMobileAds.initialize(
          context,
          new FlutterInitializationListener(result)
        );
        break;
      case "MobileAds#openAdInspector":
        flutterMobileAds.openAdInspector(
          ...
          new OnAdInspectorClosedListener() {
            @Override
            public void onAdInspectorClosed(
              @Nullable AdInspectorError adInspectorError
            ) {
      ...
      case "MobileAds#updateRequestConfiguration":
        RequestConfiguration.Builder builder = MobileAds
          .getRequestConfiguration()
          .toBuilder();
        String maxAdContentRating = call.argument("maxAdContentRating");
        Integer tagForChildDirectedTreatment = call.argument(
          "tagForChildDirectedTreatment"
        );
        Integer tagForUnderAgeOfConsent = call.argument(
      ...
      case "MobileAds#registerWebView":
        ...
        flutterMobileAds.registerWebView(
          webViewId,
          pluginBinding.getFlutterEngine()
        );
        result.success(null);
        break;
      case "loadBannerAd":
      ...
      case "loadNativeAd":
        {
          ...
          final FlutterNativeTemplateStyle templateStyle = call.argument(
            "nativeTemplateStyle"
          );
          if (factory == null && templateStyle == null) {
            final String message = String.format(
              "No NativeAdFactory with id: %s or nativeTemplateStyle",
              factoryId
            );
          ...
          final FlutterNativeAd nativeAd = new FlutterNativeAd.Builder(context)
            ...
            .setNativeAdOptions(
              call.<FlutterNativeAdOptions>argument("nativeAdOptions")
            )
      ...
      case "loadPreloadNativeAd":
        {
          final FlutterPreloadNativeAd preloadNativeAd = new FlutterPreloadNativeAd.Builder(
            context
          )
            .setManager(instanceManager)
            .setAdUnitId(call.<String>argument("adUnitId"))
      ...
      case "setPlatformView":
        {
          final String nativeAdFactoryId = call.argument("factoryId");
          final NativeAdFactory nativeAdFactory = nativeAdFactories.get(
            nativeAdFactoryId
          );
          final FlutterNativeTemplateStyle nativeAdTemplateStyle = call.argument(
            "nativeTemplateStyle"
          );
          if (nativeAdFactory == null && nativeAdTemplateStyle == null) {
            final String message = String.format(
              "No NativeAdFactory with id: %s or nativeTemplateStyle",
              nativeAdFactoryId
            );
          ...
          final Integer adId = call.<Integer>argument("adId");

          FlutterPreloadNativeAd ad = (FlutterPreloadNativeAd) instanceManager.adForId(
            adId
          );
          if (ad == null) {
            final String message = String.format("No Ad with id: %s", adId);
            result.error("NativeAdError", message, null);
            break;
          }
          ad.setPlatformView(nativeAdFactory, nativeAdTemplateStyle);
          result.success(null);
          break;
        }
      case "loadInterstitialAd":
        ...
        break;
      case "loadRewardedAd":
        final String rewardedAdUnitId = requireNonNull(
          call.<String>argument("adUnitId")
        );
        final FlutterAdRequest rewardedAdRequest = call.argument("request");
        final FlutterAdManagerAdRequest rewardedAdManagerRequest = call.argument(
          "adManagerRequest"
        );
        ...
        if (rewardedAdRequest != null) {
          ...
          result.error(
            "InvalidRequest",
            "A null or invalid ad request was provided.",
            null
          );
          break;
        }
      ...
      case "loadAdManagerBannerAd":
        final FlutterAdManagerBannerAd adManagerBannerAd = new FlutterAdManagerBannerAd(
          call.<Integer>argument("adId"),
          instanceManager,
          call.<String>argument("adUnitId"),
        ...
        break;
      case "loadFluidAd":
        final FluidAdManagerBannerAd fluidAd = new FluidAdManagerBannerAd(
          call.<Integer>argument("adId"),
          instanceManager,
          call.<String>argument("adUnitId"),
          call.<FlutterAdManagerAdRequest>argument("request"),
      ...
      case "loadAdManagerInterstitialAd":
        final FlutterAdManagerInterstitialAd adManagerInterstitialAd = new FlutterAdManagerInterstitialAd(
          call.<Integer>argument("adId"),
          requireNonNull(instanceManager),
      ...
      case "loadRewardedInterstitialAd":
        final String rewardedInterstitialAdUnitId = requireNonNull(
          call.<String>argument("adUnitId")
        );
        final FlutterAdRequest rewardedInterstitialAdRequest = call.argument(
          "request"
        );
        final FlutterAdManagerAdRequest rewardedInterstitialAdManagerRequest = call.argument(
          "adManagerRequest"
        );
      ...
      case "AdSize#getAnchoredAdaptiveBannerAdSize":
        final FlutterAdSize.AnchoredAdaptiveBannerAdSize size = new FlutterAdSize.AnchoredAdaptiveBannerAdSize(
          context,
      ...
      case "setImmersiveMode":
        (
          (FlutterOverlayAd) instanceManager.adForId(
            call.<Integer>argument("adId")
          )
      ...
      case "setServerSideVerificationOptions":
        {
          ...
          final FlutterServerSideVerificationOptions options = call.argument(
          ...
          if (ad == null) {
            ...
            (
              (FlutterRewardedInterstitialAd) ad
            ).setServerSideVerificationOptions(options);
          } else {
            Log.w(
              TAG,
              "Error - setServerSideVerificationOptions called on " +
              "non-rewarded ad"
            );
          }
          result.success(null);
