...
class FlutterPreloadNativeAdLoadedListener implements OnNativeAdLoadedListener {

  private final WeakReference<FlutterPreloadNativeAd> nativeAdWeakReference;

  FlutterPreloadNativeAdLoadedListener(
    FlutterPreloadNativeAd flutterPreloadNativeAd
  ) {
    nativeAdWeakReference = new WeakReference<>(flutterPreloadNativeAd);
  }
